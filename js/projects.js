const projects = [
  ...
  },
  {
    ...
    category: 'design',
    year: 2025,
    shortDesc: "Identité visuelle fictive pour Silence ça Tourne, vidéaste monteur — projet de cours.",
    longDesc: "Projet fictif réalisé dans le cadre des cours. Un loup comme mascotte pour Silence ça Tourne, vidéaste monteur freelance. Logotype en noir pour qu'il passe partout, déclinaisons (monochrome, négatif), carte de visite recto/verso et mockups.",
    role: ['direction artistique', 'identité visuelle', 'print'],
    tools: ['Illustrator', 'Photoshop'],
    context: ['projet fictif', 'cours BUT MMI', '2025'],
  ...
  },
  {
    ...
    category: 'design',
    year: 2025,
    shortDesc: "Logo et charte graphique pour HECom', agence 360 fictive — projet de cours.",
    longDesc: "Projet fictif réalisé dans le cadre des cours : créer une agence de communication 360. J'ai pris en charge le logo et la charte graphique. Double chevron comme symbole, Montserrat Extra Bold, palette bleu/blanc. Déclinaisons fond sombre, noir et monochrome, avec un guide d'utilisation.",
    role: ['direction artistique', 'identité visuelle', 'charte graphique'],
    tools: ['Illustrator', 'InDesign'],
    context: ['projet fictif', 'agence 360', 'cours BUT MMI · 2025'],
